...
def fix_concept(concept_name):
    ...
    # Prompt Gemini for the rest (40 examples, 24 blanks, 24 speaking)
    prompt = f"""
    ...
    try:
        # Increase max_tokens significantly because the output is large
...
if __name__ == '__main__':
    fix_concept('Daily Conversation')
